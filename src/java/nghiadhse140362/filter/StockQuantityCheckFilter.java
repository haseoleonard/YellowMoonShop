 ...
 * @author haseo
 */
public class StockQuantityCheckFilter implements Filter {
    private static final Logger LOGGER = Logger.getLogger(StockQuantityCheckFilter.class);
    ...
    public StockQuantityCheckFilter() {
    }    
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
//            log("StockQuantityCheckFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
//            log("StockQuantityCheckFilter:doFilter()");
        }
            ...
            if(session!=null){
                ...
                if(cart!=null){
                    ...
                    for (Map.Entry<Integer, CartItemObject> entry : items.entrySet()) {
                        ...
                        int quantity = productsDAO.getQuantityByID(key);
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
//                log("StockQuantityCheckFilter:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("StockQuantityCheckFilter()");
        }
        StringBuffer sb = new StringBuffer("StockQuantityCheckFilter(");
