 ...
 * @author haseo
 */
@WebServlet(name = "CategoryCreateServlet", urlPatterns = {"/CategoryCreateServlet"})
public class CategoryCreateServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            if(txtCategoryName!=null&&!txtCategoryName.trim().isEmpty()){
                CategoriesDAO categoriesDAO = new CategoriesDAO();
                categoriesDAO.createCategory(txtCategoryName);
            }
        } catch (SQLException | NamingException ex) {
            LOGGER.error(ex.getMessage());
        }finally{
            response.sendRedirect(Constants.CREATE_PRODUCT_PAGE);
        }
    }
